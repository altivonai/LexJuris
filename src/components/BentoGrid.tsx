        ...
        return (
          <AnimateOnScroll key={service.slug} delay={i * 0.08}>
            <Link
              ...
              className={`group relative bg-white rounded-2xl border border-slate-200 hover:border-amber-300 transition-all duration-300 hover:shadow-xl hover:shadow-amber-500/5 hover:-translate-y-1 flex flex-col h-full overflow-hidden ${
            ...
            >
              <div className={`${isLarge ? 'p-7 lg:p-8' : 'p-6'}`}>
                ...
                <div className="w-12 h-12 rounded-xl bg-slate-100 group-hover:bg-amber-50 flex items-center justify-center mb-5 transition-colors">
                  <service.icon className="w-5 h-5 text-slate-500 group-hover:text-amber-600 transition-colors" />
                </div>
                ...
                {/* Link */}
                <span className="mt-5 inline-flex items-center gap-1.5 text-sm font-medium text-amber-700 group-hover:text-amber-600 transition-colors">
                  Læs mere <ArrowRight className="w-4 h-4 group-hover:translate-x-0.5 transition-transform" />
                </span>
              </div>

              {/* Bottom accent line on hover */}
              <div className="absolute bottom-0 left-0 right-0 h-[2px] bg-amber-600 scale-x-0 group-hover:scale-x-100 transition-transform origin-left" />
            </Link>
          </AnimateOnScroll>
        );
      })}
