...
export default function Footer() {
  return (
    <footer className="bg-slate-950 text-slate-400">
      ...
      <div className="h-[2px] bg-gradient-to-r from-transparent via-cyan-500 to-transparent opacity-40" />
      ...
      <div className="border-b border-slate-800/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <Link
            href="/gratis-samtale"
            className="bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-semibold text-sm px-6 py-3 rounded-lg transition-all hover:scale-[1.02] whitespace-nowrap"
          >
            Book gratis samtale
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="text-center sm:text-left">
            ...
            <div className="flex gap-3 mt-5 justify-center sm:justify-start">
              <a
                ...
                className="w-9 h-9 rounded-lg bg-slate-800 flex items-center justify-center hover:bg-cyan-500 hover:text-slate-950 transition-all hover:scale-105 text-slate-400"
                aria-label="Facebook"
              >
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="space-y-2.5">
              {footerServices.map((s) => (
                <li key={s.href}>
                  <Link href={s.href} className="text-sm text-slate-500 hover:text-cyan-400 transition-colors">
                    {s.name}
                  </Link>
                </li>
              ))}
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="space-y-2.5">
              {footerLinks.map((l) => (
                <li key={l.href}>
                  <Link href={l.href} className="text-sm text-slate-500 hover:text-cyan-400 transition-colors">
                    {l.name}
                  </Link>
                </li>
              ))}
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="tel:70707122" className="flex items-center gap-2.5 text-sm hover:text-cyan-400 transition-colors justify-center sm:justify-start">
                  <Phone className="w-4 h-4 text-cyan-500 shrink-0" />
                  70 70 71 22
                </a>
              </li>
              <li>
                <a href="mailto:info@lexjuris.dk" className="flex items-center gap-2.5 text-sm hover:text-cyan-400 transition-colors justify-center sm:justify-start">
