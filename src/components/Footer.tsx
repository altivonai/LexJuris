          ...
          <div className="text-center sm:text-left">
            ...
            <div className="flex gap-3 mt-5 justify-center sm:justify-start">
              <a
                ...
                className="w-9 h-9 rounded-lg bg-amber-600/10 border border-amber-600/20 flex items-center justify-center hover:bg-amber-600 hover:text-white transition-all hover:scale-105 text-amber-500"
                aria-label="Facebook"
              >
